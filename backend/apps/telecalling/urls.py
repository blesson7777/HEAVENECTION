...
urlpatterns = [
    ...
    path("leads/<uuid:lead_id>/recover/", views.lead_recover_api, name="api-lead-recover"),
    ...
    path("staff/notifications/", views.staff_notifications_api, name="api-staff-notifications"),
